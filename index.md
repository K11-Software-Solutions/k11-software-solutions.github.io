...
<div class="hero">
  <div class="hero-content">
    <h1>Welcome to K11 Software Solutions</h1>
...
<section class="why-choose-us">
  ...
  <div class="reasons-grid">
    <div class="reason">
      <h3>✨ Innovation</h3>
      <p>We leverage the latest technologies and best practices to build modern, future-proof solutions.</p>
    </div>
    <div class="reason">
      <h3>🎯 Quality</h3>
      <p>Every project is crafted with attention to detail, rigorous testing, and a commitment to excellence.</p>
    </div>
    <div class="reason">
      <h3>🤝 Collaboration</h3>
      <p>We work closely with you throughout the development process, ensuring transparency and alignment.</p>
    </div>
    <div class="reason">
      <h3>🛡️ Integrity</h3>
      <p>We build trust through honest communication, reliable delivery, and ethical business practices.</p>
    </div>
  </div>
</section>
